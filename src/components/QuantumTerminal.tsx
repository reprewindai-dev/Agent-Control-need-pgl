...
export default function QuantumTerminal() {
  ...
  const [providers, setProviders] = useState<ProviderConfig[]>([
    { id: 'ollama', name: 'Ollama (Local/Sovereign 24/7)', enabled: true, baseUrl: 'http://localhost:11434' },
    { id: 'openai', name: 'OpenAI (GPT-4o BYOK)', enabled: true },
    { id: 'anthropic', name: 'Anthropic (Claude 3.5 BYOK)', enabled: true },
    { id: 'groq', name: 'Groq (Llama-3.1 BYOK)', enabled: true }
  ]);
