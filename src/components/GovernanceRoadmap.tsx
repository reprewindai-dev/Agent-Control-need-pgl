      ...
      <div className="relative">
        ...
        <div className="space-y-6">
          {phases.length > 0 ? phases.map((phase, i) => (
            ...
            <div className="text-white/20 font-mono text-[10px] uppercase text-center py-10 ml-12 border border-dashed border-white/5 rounded-xl">
              No roadmap phases defined.
            </div>
          )}
        </div>
      </div>
